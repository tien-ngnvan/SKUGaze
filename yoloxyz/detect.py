...
from backbones.yolov7.utils.general import check_img_size, check_requirements, xyxy2xywh, set_logging, increment_path
from backbones.yolov7.utils.torch_utils import select_device, time_synchronized
from backbones.yolov7.utils.general import check_imshow, apply_classifier, strip_optimizer
from backbones.yolov7.utils.torch_utils import load_classifier
from backbones.yolov7.models.experimental import attempt_load

from multitasks.utils.datasets import LoadStreams, LoadImages
from multitasks.utils.general import non_max_suppression, scale_coords, save_one_box
from multitasks.utils.plots import colors, plot_one_box
